      ...
      <div>
        ...
        <div className=''>
          <div className='flex  flex-col'>
            ...
            <div className='flex items-center justify-center cursor-pointer transition duration-500 hover:text-primary text-black'><BiMailSend className='text-xl mr-1 text-primary' />soulmanufacture@hotmail.com</div>
          </div>
