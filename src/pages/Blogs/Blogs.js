        ...
        <div class="mt-8 space-y-8">
          <div>
            <div class="flex items-start">
              <div>
                <span class="inline-flex justify-center items-center w-8 h-8 rounded bg-green-500 text-white font-medium text-sm">
                  Que
                </span>
              </div>
            ...
            <div class="flex items-start mt-3">
              <div>
                <span class="inline-flex justify-center items-center w-8 h-8 rounded bg-gray-200 text-gray-800 font-medium text-sm">
                  Ans
                </span>
              </div>
