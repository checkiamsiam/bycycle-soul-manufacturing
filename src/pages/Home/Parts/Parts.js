    ...
    <div className='container mx-auto py-5'>
      <div>
        ...
        <div className='grid sm:grid-cols-2 lg:grid-cols-3 grid-cols-1 gap-5'>
          {sliced?.map(p => <div class=" h-screen mx-4 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700  overflow-hidden hover:shadow-orange-200">
      ...
      <div>
        ...
        <div className='grid sm:grid-cols-2 lg:grid-cols-3 grid-cols-1 gap-5'>
          {reversed?.map(p => <div class=" h-screen mx-4 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700  overflow-hidden hover:shadow-orange-200">
            <div className='overflow-hidden w-full h-1/2 '>
              <img class="rounded-t-lg w-full h-full  transition duration-500 hover:scale-110" src={p?.img} alt="" />
            </div>
            <div class="p-5 ">
